<div class="s-bk-lf">
	<div class="acc-title">Payeer выплаты</div>
</div>
<div class="silver-bk"><div class="clr"></div>	
<center><a href="/?menu=myadmin72g52u8&sel=payments">Выплачено</a> || <a href="/?menu=myadmin72g52u8&sel=payments&balance">Баланс на Payeer</a> || 
<a href="/?menu=myadmin72g52u8&sel=payments&list_day">По дням</a> || <a href="/?menu=myadmin72g52u8&sel=payments&last_31">График за 30 дней</a></center><BR />
<?PHP
# График
...
$db->Query("SELECT * FROM db_payment ORDER BY id DESC LIMIT {$lim}, 20");
...
<?PHP
	...
	?>
	<tr class="htt">
	<td align="center"><a href="/?menu=myadmin72g52u8&sel=users&edit=<?=$data["user_id"]; ?>" class="stn"><?=$data["user"]; ?></a></td>
...
$all_pages = $db->FetchRow();
	...
	echo "<BR /><center>".$nav->Navigation(10, $page, ceil($all_pages / 100), "/?menu=myadmin72g52u8&sel=payments&page="), "</center>";
