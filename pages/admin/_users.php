...
$type = ($_POST["type"] == 1) ? "-1" : "+1";
	...
	$db->Query("SELECT *, INET_NTOA(al_polzov_a.ip) uip FROM al_polzov_a, db_users_b WHERE al_polzov_a.id = db_users_b.id AND db_users_b.id = '$eid' LIMIT 1");
	echo "<center><b>Успешно добавлено</b></center><BR />";
...
<table width="100%" border="0">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">Серебра на (Покупки):</td>
    <td width="200" align="center"><?=sprintf("%.2f",$data["money_b"]); ?></td>
  </tr>
  
  <tr>
    <td style="padding-left:10px;">Серебра на (Вывод):</td>
  ...
  <tr>
    <td style="padding-left:10px;">(БТР-44):</td>
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;"> (Гаубица МЛ-20):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">(Танк T-34):</td>
    <td width="200" align="center">
  ...
  <tr bgcolor="#efefef">
    <td style="padding-left:10px;">(Катюша БМ-13):</td>
    <td width="200" align="center">
  ...
  <tr>
    <td style="padding-left:10px;">(Самолет И-16):</td>
    <td width="200" align="center">
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  <tr bgcolor="#efefef">
    ...
    <td align="center" width="90" class="m-tb"><a href="/?menu=myadmin72g52u8&sel=users&sort=2" class="stn-sort">Серебра</a></td>
	<td align="center" width="75" class="m-tb"><a href="/?menu=myadmin72g52u8&sel=users&sort=3" class="stn-sort">Ферм</a></td>
	<td align="center" width="100" class="m-tb"><a href="/?menu=myadmin72g52u8&sel=users&sort=4" class="stn-sort">Зарегистрирован</a></td>
  </tr>
